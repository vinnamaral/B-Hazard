...
begin
  ...
  edtAno.Text := dm.cdsLivro.FieldByName('ANO').AsString;
  speCod.SetFocus;
end;
...
procedure TFormLivros.edtAnoKeyPress(Sender: TObject; var Key: Char);
begin
...
begin
  ...
  dm.cdsLivro.FieldByName('ANO').Value:= edtAno.Text;
